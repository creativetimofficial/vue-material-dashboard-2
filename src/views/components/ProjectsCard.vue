                ...
                <div class="col-lg-6 col-5 my-auto text-end">
                  <div class="dropdown float-lg-end pe-4">
                    ...
                    <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable" style="">
                      ...
                      <li><a class="dropdown-item border-radius-md" href="javascript:;">{{AnotherAction}}</a></li>
                      <li><a class="dropdown-item border-radius-md" href="javascript:;">{{SomethingElse}}</a></li>
                    </ul>
                  </div>
                </div>
              </div>
